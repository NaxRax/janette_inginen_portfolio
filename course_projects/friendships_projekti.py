...
def add_friendship(network, name1, name2):
    ...
    if name1 not in network:
        ...
        network[name1] = network[name1].append(name2)
    if name2 not in network:
        list2.append(name1)
        network[name2] = list2
    else:
        network[name2] = network[name2].append(name1)
...
def print_command(network, namelist):
    ...
    for item in network:
        print(item)
        if len(network[item]) == 1:
            print("- " + network[item])
        else:
            for friend in network[item]:
                print("- " + friend)
...
def common_friends_command(network, namelist):
    ...
    if name1 == name2:
        ...
        friendsexist = False
        friends1 = network[name1]
        friends2 = network[name2]
